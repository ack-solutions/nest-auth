...
import { NestAuthPlatformAccess } from './entities/platform-access.entity';

@Module({
    imports: [
        TypeOrmModule.forFeature([NestAuthUser, NestAuthAccessKey, NestAuthIdentity, NestAuthUserAccess, NestAuthPlatformAccess]),
