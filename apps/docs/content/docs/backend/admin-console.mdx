...
|---|---|
| Users | List, search, edit, suspend, reactivate, view sessions, force logout-all, reset MFA, filter by access scope, manage [platform roles](/docs/backend/admin-platform-users) |
