...
| `MUST_CHANGE_PASSWORD` | 403 | `mustChangePassword.enforce` is on and the user must set a new password — route to change-password. See the [force-password-change recipe](/docs/recipes/force-password-change) |
