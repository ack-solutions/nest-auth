...
> Already on v2 and just bumping a minor (e.g. `2.0.x → 2.2.x`)? That's additive/non-breaking — see **[Upgrading within v2](/docs/changelog/migrations#upgrading-within-v2-20x--22x)** instead; this page is only for the v1 → v2 jump.
