...
This guide takes an existing **v1.x** app (baseline `1.1.69-beta.x`) to **v2** (`2.0.1`). It is exhaustive — every change a consumer can observe is listed, grouped so you can jump to what you use. A typical app upgrades in **1–2 hours**; longer if you have many custom hooks or a hand-managed database schema.
