...
- [Architecture](/docs/introduction/architecture) — how the packages fit together.
- [Core Concepts](/docs/concepts) · [User Model](/docs/concepts/user-model) — the patterns these principles produce.
- [Getting started](/docs/getting-started) — put the philosophy into practice.
